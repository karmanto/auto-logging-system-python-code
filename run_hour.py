...
def getRunSeconds_func(pin):
	db = MySQLdb.connect(host="localhost", user="root", passwd="root", db="logging")
	cur = db.cursor()
...
def firstRun_func():
	...
	GPIO.add_event_detect(buttonArray[0], GPIO.BOTH, handle)
	GPIO.add_event_detect(buttonArray[1], GPIO.BOTH, handle)
	GPIO.add_event_detect(buttonArray[2], GPIO.BOTH, handle)
	GPIO.add_event_detect(buttonArray[3], GPIO.BOTH, handle)
	GPIO.add_event_detect(buttonArray[4], GPIO.BOTH, handle)
	GPIO.add_event_detect(buttonArray[5], GPIO.BOTH, handle)
	GPIO.add_event_detect(buttonArray[6], GPIO.BOTH, handle)
	GPIO.add_event_detect(buttonArray[7], GPIO.BOTH, handle)
	GPIO.add_event_detect(buttonArray[8], GPIO.BOTH, handle)
	GPIO.add_event_detect(buttonArray[9], GPIO.BOTH, handle)
	GPIO.add_event_detect(buttonArray[10], GPIO.BOTH, handle)
	GPIO.add_event_detect(buttonArray[11], GPIO.BOTH, handle)
	GPIO.add_event_detect(buttonArray[12], GPIO.BOTH, handle)
	GPIO.add_event_detect(buttonArray[13], GPIO.BOTH, handle)
	GPIO.add_event_detect(buttonArray[14], GPIO.BOTH, handle)
	GPIO.add_event_detect(buttonArray[15], GPIO.BOTH, handle)
	GPIO.add_event_detect(buttonArray[16], GPIO.BOTH, handle)
	GPIO.add_event_detect(buttonArray[17], GPIO.BOTH, handle)	
